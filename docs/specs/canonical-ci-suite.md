...
Data: 22/09/2026; atualização: 26/09/2026. **Estado:** gate de aceite obrigatório e rulesets do QA ativos; promoção pós-proteção comprovada, isolamento final e negativas restantes em validação. Vinculada às [ADRs 0006](../decisions/0006-canonical-ci-suite.md) e [0009](../decisions/0009-public-qa-protected-branches.md) e à [#31 / F0-T2](https://github.com/IgnisDevNE/CircuitoNE/issues/31).
