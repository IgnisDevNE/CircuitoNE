...
**Bloqueios por issue:** Nenhum para manter o upload Cloud já implantado. O acesso à organização da instância própria foi verificado em [#29](https://github.com/IgnisDevNE/CircuitoNE/issues/29); a migração ainda precisa comprovar upload e comentário em [#30](https://github.com/IgnisDevNE/CircuitoNE/issues/30), com token isolado conforme [#31](https://github.com/IgnisDevNE/CircuitoNE/issues/31). Ver [ADR 0007](../../decisions/0007-codecov-self-hosted-target.md); o workflow Cloud vigente continua descrito na [ADR 0004](../../decisions/0004-codecov-cloud.md).
...
**Estado:** cobertura e artefatos entregues pelo PR #45; upload Cloud de PR interno e baseline `main` confirmados após #47. A configuração da API própria e o token protegido foram preparados; o primeiro upload real e o comentário permanecem em #30. A [ampliação de cobertura](../../reviews/coverage-backlog-2026-09-22.md) registra testes de interação e correções do roteador; não satisfaz aceite canônico. **Dependência:** F0-T6 para gerar LCOV. **Risco:** médio.
