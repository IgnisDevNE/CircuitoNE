...
Estado: contrato implementado em F0-T7; integração e homologação pendentes na [#11](https://github.com/IgnisDevNE/CircuitoNE/issues/11). Data: 23/09/2026.
...
Tradeoff: o parser mantido aumenta o bundle, mas evita manter um parser próprio de Markdown e preserva links válidos com parênteses. O editor continua sendo texto simples; não há upload ou incorporação de mídia nessa descrição.
