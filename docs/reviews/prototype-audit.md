...
|---|---|---|
| [UI-01 / P1](https://github.com/IgnisDevNE/CircuitoNE/issues/11) | `Markdown.tsx:7–11,36`: URLs entram por substituição de string em atributo HTML sem escapar aspas; `dangerouslySetInnerHTML` recebe resultado. Há caminho de injeção de atributos e risco de XSS quando conteúdo vier de usuários. Não foi executado payload ativo. | F0-T7; teste de conteúdo malicioso antes da correção; renderizar nós React seguros ou usar biblioteca/sanitização mantida. |
