...
| [Markdown da descrição de eventos](event-description-markdown.md) | Contrato técnico implementado em F0-T7; integração pendente | Formatos, URLs, renderização segura e regressões |
