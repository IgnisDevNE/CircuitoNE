...
**Direção aprovada em 22/09/2026:** concentrar o aceite e a atualização da suíte na esteira, poupando recursos locais ([ADR 0006](../decisions/0006-canonical-ci-suite.md), [spec](../specs/canonical-ci-suite.md), [controle de mudanças](../controls/change-control.md), [controle de acesso](../controls/access-control.md)). Comparar o conjunto protegido com a versão aprovada e executar os testes com comando/configuração de origem independente do PR. Novos testes recebem revisão específica e SHA fixado antes da implementação; a proposta revisada pode validar a tarefa, mas só vira referência global depois do merge e da validação do commit integrado. O check obrigatório do App Publisher está ativo; a promoção automática passou nos ensaios das PRs #56 e #57 antes dos rulesets de QA. A promoção pós-proteção passou nas PRs #99, #110 e #112; os ensaios negativos #111 e #114 comprovaram rejeição de comandos falsos e testes sem revisão, respectivamente. Evidências e limites ficam no controle de mudanças; negativas restantes, janela de merge e retirada das credenciais locais continuam na #31. CI verde sozinho não aprova testes novos ou alterados.
