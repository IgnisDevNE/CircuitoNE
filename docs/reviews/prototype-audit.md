...
| [UI-17 / P2](https://github.com/IgnisDevNE/CircuitoNE/issues/27) | Na base auditada, `EventPage.tsx` colocava botão dentro de link e a Home repetia h1 nos títulos de seção. O cadastro também mantinha foco no botão após erro de validação e não associava erros aos rádios. | F0-T10 corrigiu os casos semânticos e liga os erros do cadastro aos campos, focando o primeiro inválido. #27 permanece aberta para auditar teclado, foco/erros e zoom nas demais jornadas antes do aceite completo. |
